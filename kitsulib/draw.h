...
namespace klib
{
	...
	SGameState drawCredits(_TCell* display, uint32_t width, uint32_t depth, double lastFrameTime, const std::string (&namesCredits)[_LineCount], const SGameState& returnValue) {
	...
	SGameState drawCredits(::nwol::SGrid<_TCell, _Width, _Depth>& display, double lastFrameTime, const std::string (&namesCredits)[_LineCount], const SGameState& returnValue) {
