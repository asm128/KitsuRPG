...
#pragma pack(push, 1)
	...
	{
		::nwol::SCoord3<int32_t>								Cell											;	// Position in tile map.
		::nwol::SCoord3<float>									Offset											;	// Position between 0 and 1 relative to the tile.
...
#define MAX_MAP_BULLET_COORDS ((MAX_MAP_SHOTS)*100) 
	typedef SEntityContainer<::nwol::SCoord3<int32_t>, MAX_MAP_BULLET_COORDS> SCoordContainerBullet;
	struct SMapShots
	{
	...
	typedef SEntityContainer<::nwol::SCoord3<int32_t>, MAX_INVENTORY_SLOTS> SCoordContainerEntity;
...
#define MAX_MAP_AOE_COORDS	((MAX_AOE_SLOTS)*100)
	typedef SEntityContainer<::nwol::SCoord3<int32_t>, MAX_MAP_AOE_COORDS> SCoordContainerAOE;
	struct SMapAOE
	{
...
#define GAME_MAP_WIDTH	(GAME_MAP_DEPTH*2)
	...
	struct STacticalInfo
	{
		...
		bool													HasDrops										(const nwol::SCoord3<int32_t>& coord)	const	noexcept	{
