...
static const ::nwol::glabel labelAccessory	= "Accessory"		;
static const ::nwol::glabel labelStageProp	= "Stage Prop"		;
static const ::nwol::glabel labelFacility	= "Facility"		;
static const ::nwol::glabel labelVehicle	= "Vehicle"			;
static const ::nwol::glabel labelJob		= "Job License"		;
static const ::nwol::glabel labelWeapon	= "Weapon"			;
static const ::nwol::glabel labelArmor		= "Armor"			;
static const ::nwol::glabel labelItem		= "Item"			;


bool	equipIfResearchedProfession	(SGame& instanceGame, int32_t indexAgent, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_INDEX_USER]; static const ::nwol::glabel modifierTypeName = "Rank"			, entityTypePlural = "Licenses"		; CCharacter& playerAgent = *player.Army[indexAgent];	bool bResult = equipIfResearched(selectedChoice, playerAgent, player.Goods.Inventory.Profession	, playerAgent.CurrentEquip.Profession	, player.Goods.CompletedResearch.Profession	, playerAgent.Goods.CompletedResearch.Profession	, definitionsProfession		, modifiersProfession	, modifierTypeName, instanceGame.UserSuccess, instanceGame.UserError); if(bResult)instanceGame.LogSuccess(); else instanceGame.LogError(); return bResult;};
bool	equipIfResearchedWeapon		(SGame& instanceGame, int32_t indexAgent, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_INDEX_USER]; static const ::nwol::glabel modifierTypeName = "Science"			, entityTypePlural = "Weapons"		; CCharacter& playerAgent = *player.Army[indexAgent];	bool bResult = equipIfResearched(selectedChoice, playerAgent, player.Goods.Inventory.Weapon		, playerAgent.CurrentEquip.Weapon		, player.Goods.CompletedResearch.Weapon		, playerAgent.Goods.CompletedResearch.Weapon		, definitionsWeapon			, modifiersWeapon		, modifierTypeName, instanceGame.UserSuccess, instanceGame.UserError); if(bResult)instanceGame.LogSuccess(); else instanceGame.LogError(); return bResult;};
bool	equipIfResearchedArmor		(SGame& instanceGame, int32_t indexAgent, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_INDEX_USER]; static const ::nwol::glabel modifierTypeName = "Technology"		, entityTypePlural = "Armors"		; CCharacter& playerAgent = *player.Army[indexAgent];	bool bResult = equipIfResearched(selectedChoice, playerAgent, player.Goods.Inventory.Armor		, playerAgent.CurrentEquip.Armor		, player.Goods.CompletedResearch.Armor		, playerAgent.Goods.CompletedResearch.Armor			, definitionsArmor			, modifiersArmor		, modifierTypeName, instanceGame.UserSuccess, instanceGame.UserError); if(bResult)instanceGame.LogSuccess(); else instanceGame.LogError(); return bResult;};
bool	equipIfResearchedAccessory	(SGame& instanceGame, int32_t indexAgent, int16_t selectedChoice){ SPlayer& player = instanceGame.Players[PLAYER_INDEX_USER]; static const ::nwol::glabel modifierTypeName = "Crafting"		, entityTypePlural = "Accessories"	; CCharacter& playerAgent = *player.Army[indexAgent];	bool bResult = equipIfResearched(selectedChoice, playerAgent, player.Goods.Inventory.Accessory	, playerAgent.CurrentEquip.Accessory	, player.Goods.CompletedResearch.Accessory	, playerAgent.Goods.CompletedResearch.Accessory		, definitionsAccessory		, modifiersAccessory	, modifierTypeName, instanceGame.UserSuccess, instanceGame.UserError); if(bResult)instanceGame.LogSuccess(); else instanceGame.LogError(); return bResult;};
