...
namespace klib
{
	static inline constexpr bool mouseOver(int32_t mouseX, int32_t mouseY, int32_t offsetX, int32_t offsetY, int32_t width)
	{
		return (mouseY == offsetY) && (mouseX >= offsetX) && (mouseX < offsetX+width);
	}
